...
class Db
{
    ...
    {
        try {
            $this->dsn = 'mysql:host='.$dbConfig['host'].';dbname='.$dbConfig['name'];
            $this->dbh = new PDO($this->dsn, $dbConfig['user'], $dbConfig['pass']);
            $this->dbh->exec('SET character_set_connection='.$dbConfig['charset'].', character_set_results='.$dbConfig['charset'].', character_set_client=binary');
